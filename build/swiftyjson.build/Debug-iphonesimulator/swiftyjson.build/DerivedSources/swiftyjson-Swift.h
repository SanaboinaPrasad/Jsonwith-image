...
SWIFT_CLASS("_TtC10swiftyjson17AnimatedImageView")
...
SWIFT_CLASS("_TtC10swiftyjson11AppDelegate")
...
SWIFT_CLASS("_TtC10swiftyjson29ImageDownloaderSessionHandler")
...
SWIFT_CLASS("_TtC10swiftyjson13TableViewCell")
@interface TableViewCell : UITableViewCell
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified lblArtist;
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified img;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified lblTrack;
- (void)awakeFromNib;
...
@interface UIImageView (SWIFT_EXTENSION(swiftyjson))
- (BOOL)shouldPreloadAllAnimation SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC10swiftyjson14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(swiftyjson)) <UITableViewDataSource, UITableViewDelegate>
